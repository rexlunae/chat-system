...
mod tests {
    ...
    async fn whatsapp_name_and_type() {
        let m = WhatsAppMessenger::new("my-whatsapp".to_string(), "test.db".to_string());
    ...
    async fn whatsapp_not_connected_before_initialize() {
        let m = WhatsAppMessenger::new("wa".to_string(), "test.db".to_string());
    ...
    async fn whatsapp_disconnect_without_init_is_ok() {
        let mut m = WhatsAppMessenger::new("wa".to_string(), "test.db".to_string());
